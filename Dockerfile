...
RUN source "/home/newuser/.sdkman/bin/sdkman-init.sh" && sdk install java 11.0.16-zulu
RUN source "/home/newuser/.sdkman/bin/sdkman-init.sh" && sdk install gradle 7.4
